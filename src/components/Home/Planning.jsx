...
const Planning = () => {
  return (
    <div className="bg-[#E3E3E333] w-full h-auto p-10 ">
      <div className="grid grid-cols-1 sm:grid-cols-2 justify-items-center  lg:grid-cols-4 gap-12">
        {boxes.map((item) => {
          return (
            <div
              key={item.id}
            ...
            >
              ...
              <div className="relative z-10 text-center px-4">
                ...
                <p className="text-gray-500 text-xs mt-2 leading-tight">{item.para}</p>
              </div>
            </div>
          );
        })}
